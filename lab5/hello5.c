...
MODULE_DESCRIPTION("laboratory_5");
...
static int __init hello_init(void)
{
	...
	if (amount >= 5 && amount <= 10)
		pr_warn("Parameter = %d, parameter should be greeter than 5 and less than 10, enter number less than 5", amount);
...
exception:
	{
		...
		pr_err("There is no enough memory!\n");
